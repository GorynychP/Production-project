...
-   `npm run remove-feature` - Скрипт удаление кода по featureFlags
...
используется собственный eslint plugin _eslint-plugin-path-ch-plg_,
...
-   [UIDesignedSwitcher](/src/features/UIDesignedSwitcher)
